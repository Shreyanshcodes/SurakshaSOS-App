...
public class ResellerBuyer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reseller_buyer);

        front =findViewById(R.id.frontimgclick);
        back =findViewById(R.id.backimgclick);
        buy = findViewById(R.id.finallybuy);
        prodis = findViewById(R.id.productdis);

        sellername = findViewById(R.id.sellernameas);
        sellernumber = findViewById(R.id.sellerphoneas);
        selectedImage = findViewById(R.id.fontimageview);
        selectedimage1 = findViewById(R.id.backimageview);
...
//                this.sendBroadcast(mediaScanIntent);
                ...
                docRef.set(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()) {
                            Toast.makeText(getApplicationContext(), "Please Wait for file to upload", Toast.LENGTH_SHORT).show();
                            //  finish();
                        }
                        else{
    ...
    private void askCameraPermissions(){
        ...
        permission1 = ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    private String getFileExt(Uri contentUri) {
        ContentResolver c = getParent().getContentResolver();
