...
//    }
    ...
    public void onClick(View v)
    {
        ...
        switch(v.getId())
        {
            ...
            case R.id.B_policeStations:
                ...
                getNearbyPlacesData.execute(dataTransfer);
                Toast.makeText(MapsActivity.this, "Showing Nearby Police Stations and Help Centers", Toast.LENGTH_LONG).show();
    ...
    private String getUrl(double latitude , double longitude , String nearbyPlace)
    {
        ...
        googlePlaceUrl.append("&key="+"AIzaSyCnx9X-cq7s57Ec-y7rPiIvAgMOeFD1o38");
